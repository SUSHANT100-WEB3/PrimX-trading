  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-3 sm:p-4 md:p-6 dark:bg-primary dark:shadow-lg">
      ...
      <div className="flex justify-between items-center mb-4 sm:mb-6">
        <h2 className="text-lg sm:text-xl font-bold text-gray-800 dark:text-text-dark">Activity Feed</h2>
      ...
      <div className="space-y-3 sm:space-y-4">
        {/* Activity Item 1 */}
        <div className="flex items-start space-x-2 sm:space-x-3 p-3 sm:p-4 bg-white dark:bg-primary-dark rounded-lg shadow-sm border border-gray-200 dark:border-primary">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs sm:text-sm text-gray-600 dark:text-text-secondary mt-1">3 hours ago</p>
          </div>
        </div>
        ...
        <div className="flex items-start space-x-2 sm:space-x-3 p-3 sm:p-4 bg-white dark:bg-primary-dark rounded-lg shadow-sm border border-gray-200 dark:border-primary">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs sm:text-sm text-gray-600 dark:text-text-secondary mt-1">5 hours ago</p>
          </div>
        </div>
        ...
        <div className="flex items-start space-x-2 sm:space-x-3 p-3 sm:p-4 bg-white dark:bg-primary-dark rounded-lg shadow-sm border border-gray-200 dark:border-primary">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs sm:text-sm text-gray-600 dark:text-text-secondary mt-1">1 day ago</p>
          </div>
        </div>
        ...
        <div className="flex items-start space-x-2 sm:space-x-3 p-3 sm:p-4 bg-white dark:bg-primary-dark rounded-lg shadow-sm border border-gray-200 dark:border-primary">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs sm:text-sm text-gray-600 dark:text-text-secondary mt-1">2 days ago</p>
          </div>
        </div>
      </div>
    </div>
