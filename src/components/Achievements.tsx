  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-3 sm:p-4 md:p-6 dark:bg-primary dark:shadow-lg">
      ...
      <div className="flex justify-between items-center mb-4 sm:mb-6">
        <h2 className="text-lg sm:text-xl font-bold text-gray-800 dark:text-text-dark">Achievements</h2>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4">
        {/* Achievement 1 */}
        <div className="flex flex-col items-center p-3 sm:p-4 bg-white dark:bg-primary-dark rounded-lg shadow-sm border border-gray-200 dark:border-primary">
